...
const LineChart1 = ({ ssg1, isfetch, graphList }) => {
  //////////////////////
      ...
      if (graph.value == 'v') {
        ...
        ssg1.def.tml.forEach((v0, i0) => {
          ...
          ssg1.tab[v0].data.forEach((v1, i1) => {
            if (graph.value == 'r') {
              child2[ssg1.ref[v1.p[1]].short_name] = Number(v1.r);
            } else if (graph.value == 'v') {
              child2[ssg1.ref[v1.p[1]].short_name] = v1[graph.value][0];
            } else {
              child2[ssg1.ref[v1.p[1]].short_name] = Number(v1[graph.value]);
            }
  ...
  return (
    ...
    >
      <Typography variant='h2' component='h2'>
        {ssg1.def.tl1}の都道府県別の経年推移グラフ【{ssg1.def.tmn}〜{ssg1.def.tmx}】
      </Typography>
